<template>
  <div class="toasted">
    ...
    <div>
      <p>
        提示：<span class="text-black">请先在项目中安装 <a class="text-blue" target="__blank" href="https://vue-toastification.maronato.dev">vue-toastification</a> 并引入；</span> Toasted 封装自 <span class="text-blue">vue-toastification</span> 插件，
